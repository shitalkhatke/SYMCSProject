...
@WebServlet(name = "studlogservlet", urlPatterns = {"/studlogservlet"})
public class studlogservlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
          ...
          Connection con=DriverManager.getConnection("jdbc:mysql://localhost/campus","root","");
           out.println("connected");
            Statement st=con.createStatement();
             ...
             ResultSet re=st.executeQuery("select * from studentreg "); 
        
        while(re.next())
        {
           String u1=re.getString(3); 
       ...
       if(flag==1)
        ...
        session.setAttribute("txtunm",sunm); 
